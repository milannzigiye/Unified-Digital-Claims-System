...
$senderName = resolve_display_name($conn, $senderId, 'Finance Officer');
$receiverName = resolve_display_name($conn, $receiverId, 'Recipient');
...
bk_activity_log($conn, [
    ...
    'details' => 'Finance officer sent a direct message to ' . $receiverName . '.',
    'meta' => [
